...
export const INPUT_CLASS =
  'bg-white py-2.5 px-5 text-base text-black rounded-[20px] :placeholder-dark-grey border border-1 border-grey-light focus:outline-none focus:ring-2 focus:ring-primary focus:ring-opacity-50 placeholder-gray-400';
