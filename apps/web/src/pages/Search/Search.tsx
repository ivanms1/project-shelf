...
function Search() {
  ...
  return (
    <div className='bg-black  flex justify-center'>
      <div className=' w-full max-w-[70vw] flex flex-col px-28 pt-20 pb-[3px] max-lg:px-[30px] max-lg:min-h-[70vh]'>
        ...
        {!!search && !!data?.searchProjects?.totalCount && (
          <>
            ...
            <div className=' py-14 px-28 max-lg:px-[30px] -mx-28 max-lg:mx-[-30px]'>
              <ProjectsGrid
